...
#python test.py  --config-name=conf_piano.yaml tester=piano_evaluator_BABE2 tester.checkpoint="experiments/MAESTRO_22kHz_8s-850kits.pt" id="BABE2" model_dir="experiments/maestro_unconditional" tester.modes=["unconditional"]
