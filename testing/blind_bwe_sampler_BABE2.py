...
class BlindSampler():
    ...
    def predict_bwe_AR(
        ...
        return self.predict_conditional(y, rid,  compute_sweep, x_init=x_init)
    ...
    def predict_conditional(
        ...
        return self.predict(y, rid, compute_sweep, blind=False, x_init=x_init)
    ...
    def predict_blind_bwe_AR(
        ...
        y=y.unsqueeze(0)
        return self.predict(y, rid, compute_sweep, blind=True, x_init=x_init)
